        ...
        <form @submit.prevent="submitForm">
            <fieldset class="margin-bottom-2xs">
                ...
                <div class="grid gap-sm">
                    <div class="col-6@md">
                        <label class="form-label margin-bottom-2xs" for="input-name">Name</label>
                        <input 
                            id="input-name" 
                    ...
                    <div v-if="0">
                        <label class="form-label margin-bottom-2xs" for="input-invalid">Invalid</label>
                        <input 
                            id="input-website" 
                            class="form-input form-input--error width-100%" 
                            type="text" 
                            name="input-website" 
                            aria-invalid="true" 
                            value="invalid data"
                        ...
                        <div
                            ...
                            class="bg-error bg-opacity-20% fw3-padding-xs fw3-radius-md fw3-text-sm fw3-color-contrast-higher fw3-margin-top-2xs" 
                            role="alert"
                        >
                    ...
                    <div>
                        <label class="form-label margin-bottom-2xs" for="textarea">Textarea</label>
                        <textarea class="form-input width-100%" name="textarea" id="textarea" v-model="message" ></textarea>
                        <p class="fw3-text-xs fw3-color-contrast-medium fw3-margin-top-2xs">Use helper text to provide additional information.</p>
                    </div>
                </div>
            </fieldset>
